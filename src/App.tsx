...
function App() {
	...
	return (
		...
		<div className="artWrapper">
			<div className="art1">
				<ArtDisplay title={`${arts[0]}`} 
					setModal={() => setModal({"title": `${arts[0]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art2">
				<ArtDisplay title={`${arts[1]}`} 
					setModal={() => setModal({"title": `${arts[1]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art3">
				<ArtDisplay title={`${arts[2]}`} 
					setModal={() => setModal({"title": `${arts[2]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art2">
				<ArtDisplay title={`${arts[3]}`} 
					setModal={() => setModal({"title": `${arts[3]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art1">
				<ArtDisplay title={`${arts[4]}`} 
					setModal={() => setModal({"title": `${arts[4]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art2">
				<ArtDisplay title={`${arts[5]}`} 
					setModal={() => setModal({"title": `${arts[5]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art1">
				<ArtDisplay title={`${arts[6]}`} 
					setModal={() => setModal({"title": `${arts[6]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art2">
				<ArtDisplay title={`${arts[7]}`} 
					setModal={() => setModal({"title": `${arts[7]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
			<div className="art1">
				<ArtDisplay title={`${arts[8]}`} 
					setModal={() => setModal({"title": `${arts[8]}`,"sound":"audiofiles/Kalimba.mp3"})}
				/>
			</div>
		</div>
		<div className="sectionsplit"></div>
