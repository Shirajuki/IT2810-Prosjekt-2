			...
			<div className="wrapper">
				...
				<main>
					...
					<div className="artWrapper">
						<div className="art1">
							<div>
								<InstallationDisplay title="In the Black Forest"
									onClick={() =>
										setModal({
						...
						<div className="art2">
							<div>
								<InstallationDisplay title="The Birch-Tree at Loschwitz"
									onClick={() =>
										setModal({
						...
						<div className="art3">
							<div>
								<InstallationDisplay title="A Wall Flower"
									onClick={() =>
										setModal({
											title: "A Wall Flower",
											sound: "audiofiles/Kalimba.mp3",
						...
						<div className="art2">
							<div>
								<InstallationDisplay title="Winter Song"
									onClick={() =>
										setModal({
											title: "Winter Song",
											sound: "audiofiles/Kalimba.mp3",
